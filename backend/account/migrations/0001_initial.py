    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='account.acc')),
            ],
            options={
